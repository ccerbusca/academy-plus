...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2016/03/11 17:47:51 by ccerbusc          #+#    #+#             */
/*   Updated: 2017/01/29 17:52:07 by ccerbusc         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_black		put_less(t_black fr, int iter, t_deep k)
{
	...
	offset = k.col * 4;
	offset += k.row * fr.sline;
	*(int*)(fr.str + offset) = mlx_col_name[iter].color;
	return (fr);
}
...
{
	if (k.iteration < MAXITER)
		fr = put_less(fr, k.iteration, k);
	else //if (k.iteration == MAXITER)
		fr = put_equal(fr, k);
	return (fr);
}
...
{
	k.x0 = (k.col - fr.originx) / fr.zoom;
	k.y0 = (k.row - fr.originy) / fr.zoom;
	k.x = k.x0;
	k.y = k.y0;
	return (k);
}
